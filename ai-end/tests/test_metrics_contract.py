...
class TestConformance:
    ...
    def test_metric_types_match_contract(self):
        from app.utils.metrics import (
            ...
            active_sessions, redis_connection_status, db_connection_pool_size,
            ...
            recovery_attempts_total, circuit_breaker_state,
        ...
        registry = {
            ...
            "active_sessions": active_sessions, "redis_connection_status": redis_connection_status,
